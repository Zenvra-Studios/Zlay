...
VALID_BACKENDS = ("auto", "x11", "gtk", "win32", "cocoa")
...
def expected_layout_files(args: argparse.Namespace) -> list[Path]:
    ...
    if args.os:
        files += [
            SOURCE_DIR / "os" / "zlay_dpi.c",
            SOURCE_DIR / "os" / "zlay_dpi.h",
            SOURCE_DIR / "os" / "zlay_native.h",
            SOURCE_DIR / "os" / "zlay_os.h",
            SOURCE_DIR / "os" / "zlay_platform.h",
            SOURCE_DIR / "os" / "event" / "zlay_event.c",
            SOURCE_DIR / "os" / "event" / "zlay_event.h",
            SOURCE_DIR / "os" / "event" / "zlay_input.c",
            SOURCE_DIR / "os" / "event" / "zlay_input.h",
            SOURCE_DIR / "os" / "event" / "zlay_keycode.h",
            SOURCE_DIR / "os" / "event" / "zlay_mouse.h",
            SOURCE_DIR / "os" / "window" / "zlay_cursor.c",
            SOURCE_DIR / "os" / "window" / "zlay_cursor.h",
            SOURCE_DIR / "os" / "window" / "zlay_monitor.c",
            SOURCE_DIR / "os" / "window" / "zlay_monitor.h",
            SOURCE_DIR / "os" / "window" / "zlay_window.c",
            SOURCE_DIR / "os" / "window" / "zlay_window.h",
            SOURCE_DIR / "os" / "system" / "zlay_clipboard.c",
            SOURCE_DIR / "os" / "system" / "zlay_clipboard.h",
            SOURCE_DIR / "os" / "system" / "zlay_file.c",
            SOURCE_DIR / "os" / "system" / "zlay_file.h",
            SOURCE_DIR / "os" / "system" / "zlay_mutex.c",
            SOURCE_DIR / "os" / "system" / "zlay_mutex.h",
            SOURCE_DIR / "os" / "system" / "zlay_path.c",
            SOURCE_DIR / "os" / "system" / "zlay_path.h",
            SOURCE_DIR / "os" / "system" / "zlay_thread.c",
            SOURCE_DIR / "os" / "system" / "zlay_thread.h",
            SOURCE_DIR / "os" / "system" / "zlay_timer.c",
            SOURCE_DIR / "os" / "system" / "zlay_timer.h",
            SOURCE_DIR / "os" / "x11" / "zlay_x11_platform.c",
            SOURCE_DIR / "os" / "x11" / "zlay_x11_platform.h",
            SOURCE_DIR / "os" / "x11" / "zlay_x11_clipboard.c",
            SOURCE_DIR / "os" / "x11" / "zlay_x11_event.c",
            SOURCE_DIR / "os" / "x11" / "zlay_x11_native.c",
            SOURCE_DIR / "os" / "x11" / "zlay_x11_timer.c",
            SOURCE_DIR / "os" / "x11" / "zlay_x11_window.c",
            SOURCE_DIR / "os" / "gtk" / "zlay_impl_gtk.c",
            SOURCE_DIR / "os" / "gtk" / "zlay_impl_gtk.h",
            SOURCE_DIR / "os" / "win32" / "zlay_win32_backend.h",
            SOURCE_DIR / "os" / "win32" / "zlay_win32_event.c",
            SOURCE_DIR / "os" / "win32" / "zlay_win32_file.c",
            SOURCE_DIR / "os" / "win32" / "zlay_win32_native.c",
            SOURCE_DIR / "os" / "win32" / "zlay_win32_timer.c",
            SOURCE_DIR / "os" / "win32" / "zlay_win32_window.c",
            SOURCE_DIR / "os" / "winrt" / "zlay_winrt_config.h",
            SOURCE_DIR / "os" / "winrt" / "zlay_winrt_composition.cpp",
            SOURCE_DIR / "os" / "winrt" / "zlay_winrt_composition.h",
            SOURCE_DIR / "os" / "winrt" / "zlay_winrt_dpi.cpp",
            SOURCE_DIR / "os" / "winrt" / "zlay_winrt_dpi.h",
            SOURCE_DIR / "os" / "winrt" / "zlay_winrt_modern.cpp",
            SOURCE_DIR / "os" / "winrt" / "zlay_winrt_modern.h",
            SOURCE_DIR / "os" / "winrt" / "zlay_winrt_notification.cpp",
            SOURCE_DIR / "os" / "winrt" / "zlay_winrt_notification.h",
            SOURCE_DIR / "os" / "winrt" / "zlay_winrt_picker.cpp",
            SOURCE_DIR / "os" / "winrt" / "zlay_winrt_picker.h",
            SOURCE_DIR / "os" / "winrt" / "zlay_winrt_theme.cpp",
            SOURCE_DIR / "os" / "winrt" / "zlay_winrt_theme.h",
            SOURCE_DIR / "os" / "winrt" / "internal" / "zlay_winrt_internal.cpp",
            SOURCE_DIR / "os" / "winrt" / "internal" / "zlay_winrt_internal.hpp",
            SOURCE_DIR / "os" / "cocoa" / "zlay_cocoa_backend.h",
            SOURCE_DIR / "os" / "cocoa" / "zlay_cocoa_event.mm",
            SOURCE_DIR / "os" / "cocoa" / "zlay_cocoa_native.mm",
            SOURCE_DIR / "os" / "cocoa" / "zlay_cocoa_platform.h",
            SOURCE_DIR / "os" / "cocoa" / "zlay_cocoa_timer.mm",
            SOURCE_DIR / "os" / "cocoa" / "zlay_cocoa_window.mm",
        ]
