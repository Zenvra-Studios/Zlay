...
ZLAY_API bool ZLay_Win32_Init(const ZLay_Win32InitInfo* info);
ZLAY_API void ZLay_Win32_Shutdown(void);
ZLAY_API void ZLay_Win32_NewFrame(ZLay_Context* ctx, int32_t width, int32_t height);
ZLAY_API void ZLay_Win32_EnableDpiAwareness(void);
ZLAY_API float ZLay_Win32_GetDpiScaleForHwnd(void* hwnd);
ZLAY_API ZLay_OSStyleInfo ZLay_Win32_GetStyleInfo(void);
