...
#define ZLAY_OS_BACKEND_ID_ASSERT(platform_id, backend_id)                    \
  static_assert((int)(platform_id) == (int)(backend_id),                      \
                "ZLay OS platform/backend ids must stay aligned")
#elif defined(__STDC_VERSION__) && __STDC_VERSION__ >= 201112L
#define ZLAY_OS_BACKEND_ID_ASSERT(platform_id, backend_id)                    \
  _Static_assert((int)(platform_id) == (int)(backend_id),                     \
                 "ZLay OS platform/backend ids must stay aligned")
#endif

#if defined(ZLAY_OS_BACKEND_ID_ASSERT)
ZLAY_OS_BACKEND_ID_ASSERT(ZLAY_OS_PLATFORM_UNKNOWN, ZLAY_OS_BACKEND_NULL);
ZLAY_OS_BACKEND_ID_ASSERT(ZLAY_OS_PLATFORM_WIN32, ZLAY_OS_BACKEND_WIN32);
ZLAY_OS_BACKEND_ID_ASSERT(ZLAY_OS_PLATFORM_WINRT, ZLAY_OS_BACKEND_WINRT);
ZLAY_OS_BACKEND_ID_ASSERT(ZLAY_OS_PLATFORM_COCOA, ZLAY_OS_BACKEND_COCOA);
ZLAY_OS_BACKEND_ID_ASSERT(ZLAY_OS_PLATFORM_GTK, ZLAY_OS_BACKEND_GTK);
ZLAY_OS_BACKEND_ID_ASSERT(ZLAY_OS_PLATFORM_X11, ZLAY_OS_BACKEND_X11);
ZLAY_OS_BACKEND_ID_ASSERT(ZLAY_OS_PLATFORM_WAYLAND, ZLAY_OS_BACKEND_WAYLAND);
ZLAY_OS_BACKEND_ID_ASSERT(ZLAY_OS_PLATFORM_POSIX, ZLAY_OS_BACKEND_POSIX);
ZLAY_OS_BACKEND_ID_ASSERT(ZLAY_OS_PLATFORM_UNIX_BSD,
                          ZLAY_OS_BACKEND_UNIX_BSD);
ZLAY_OS_BACKEND_ID_ASSERT(ZLAY_OS_PLATFORM_SOLARIS, ZLAY_OS_BACKEND_SOLARIS);
ZLAY_OS_BACKEND_ID_ASSERT(ZLAY_OS_PLATFORM_ANDROID, ZLAY_OS_BACKEND_ANDROID);
ZLAY_OS_BACKEND_ID_ASSERT(ZLAY_OS_PLATFORM_IOS, ZLAY_OS_BACKEND_IOS);
ZLAY_OS_BACKEND_ID_ASSERT(ZLAY_OS_PLATFORM_EMSCRIPTEN,
                          ZLAY_OS_BACKEND_EMSCRIPTEN);
#undef ZLAY_OS_BACKEND_ID_ASSERT
#endif
